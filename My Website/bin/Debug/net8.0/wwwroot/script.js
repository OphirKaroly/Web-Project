...
async function Man() {
    ...
    if (data.present) {
        ...
        for (let i = 0; i < data.dialogue.length; i++) {
            ...
            await TypeWriter("text", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus a dui eros. Duis interdum erat vel eros tincidunt, quis eleifend arcu rhoncus. Sed feugiat consectetur sem, sit amet lobortis ipsum tincidunt ac. Vestibulum tristique mollis massa at viverra. Donec a suscipit lacus. Proin tristique elit sit amet turpis rhoncus lobortis. Aliquam erat volutpat.", 500);
